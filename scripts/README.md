...
./scripts/echo_battery_state.sh --topic /battery_state --once
```
...
`battery.read_enabled`, `battery.mapping_state`, and structured log events
`battery_config`, `battery_raw`, and `battery_unavailable`.
